...
<center>
        ...
        while($row = mysqli_fetch_array($result)){
            ...
            <div class='card' style='width: 14rem;'>
                ...
                <div class='card-body'>
                   ...
                   <a href='../database/deleteProduct.php? id=$row[id]' class='btn btn-danger'>حذف </a>
                   <a href='alter_product.php? id=$row[id]' class='btn btn-primary'>تعديل المنتج</a>
                </div>
            </div>
            </main>
            </center>
    ...
    '<center>
        <div >
            ...
            <br>
            <a href="add_product.php">الرجوع واضافة المنتجات من هنا</a>
        </div>
    </center>';
    }
